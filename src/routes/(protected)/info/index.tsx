  ...
  return (
    <MainLayout title="Info">
      <div class="local_navigation">
        <a href="#agenda">Agenda Convention</a>{" "}
        <a href="#location">Come Arrivate</a>{" "}
        <a href="#torneo">Regolamento Torneo</a>
      </div>
      ...
      <p>
        ...
        rotonda tenendo la sinistra si imbocca Via Prais che porta all’albergo.
      </p>
      <h4>Treno</h4>
      <p>
        Fermata alla stazione di Desenzano del Garda, linea Mi-Ve che dispone di
        un ottimo servizo taxi (10 minuti dall’hotel)
      </p>
      <h4>Aereo</h4>
      <p>
      ...
      <h3>Il trofeo</h3>
      <p>
        Questo torneo comprende tre diverse discipline: calcio, pallavolo e ping
        pong. Ognuna di queste discipline è parte integrante del torneo e
      ...
      <p>
        ...
        complessiva nelle tre discipline. Ecco come funzionano le condizioni di
        vittoria:
      </p>
      <p>esempio:</p>
      <ul>
      ...
      <ul>
        <li>
          Dragons 8 gol - Tigers 4 gol: I Dragons vincono la partita di calcio.
        </li>
      </ul>
      <h4>Pallavolo</h4>
      <p>
      ...
      <h4>Ping pong</h4>
      <p>
        Nel ping pong, la partita dura 2 ore e il vincitore è chi vince più set,
        ciascuno a 21 punti. L'arbitro assegna "+1" per ogni set vinto. Il
        risultato finale è basato sul numero di set vinti:
      </p>
      <p>esempio:</p>
      <ul>
